		...
		?>
			...
			<td>  
				<!-- <p data-placement="top" data-toggle="tooltip" title="Edit"> -->
				    ...
				    <a href='print.php?print=<?php echo $i; ?>'><input type="submit" name="print" value="PRINT RECEIPT" class="btn btn-primary btn-xs" onclick="return confirm('Are You Sure to print receipt?')">
				    </td>
