				...
				<div class="main-content-inner">
					<div class="breadcrumbs ace-save-state" id="breadcrumbs">
						<ul class="breadcrumb">
							...
							<li class="active"><i class="ace-icon fa fa-users"> </i> Search Employee</li>
						</ul><!-- /.breadcrumb -->
					</div>
		...
		?>
			...
			<td>  
				...
				<!-- <p data-placement="top" data-toggle="tooltip" title="Delete"> -->
					...
					<a href='user_search.php?delete=<?php echo $i; ?>'><input type="submit" name="delete" value="DELETE" class="btn btn-primary btn-xs" onclick="return confirm('Are You Sure to delete request of <?php echo $name; ?>?')">
					</td>
					<?php 
						...
						echo "<meta http-equiv='refresh' content='0;url=user_search.php'";
					}
 					?>
